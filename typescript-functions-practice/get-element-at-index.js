...
console.log('array string output index[3]:', getElementAtIndex(['cat', 'dog', 'mouse', 'horse'], 3));
console.log('array boolean output index[3]:', getElementAtIndex([true, false, false, false], 3));
console.log('array number output index[3]:', getElementAtIndex([88, 99, 100, 2], 3));
