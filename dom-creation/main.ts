...
function renderPokemon(pokemon: Pokemon): HTMLDivElement {
  ...
  const $h2pokemonName = document.createElement('h2');
  $h2pokemonName.textContent = pokemon.name;

  const $h3pokemonNumber = document.createElement('h3');
  ...
  $pokemonCardText.appendChild($h2pokemonName);
  $pokemonCardText.appendChild($h3pokemonNumber);
  $pokemonCardText.appendChild($pDescription);
